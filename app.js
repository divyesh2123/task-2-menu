...
{
  let menuhtml = array.map(function(value) {
    ...
    let categories = menu.map(function(value) {
    
    
      return(` <button type="button" class="filter-btn"
       data-id="breakfast" onclick="filterMenu('${value.category}')">
     ${value.category}
    </button>`)  
    })
    document.getElementById("menu").innerHTML = menuhtml.join("");
    
    document.getElementById("btn").innerHTML = categories.join("");
